    ...
    <div class="contenter">
      <homelist :txt_title="timeLimit.title">
        ...
        <div
          slot="componentItem"
          class="componentItem"
          v-for="(item,index) in timeLimit.group_list"
          :key="index"
        >
          <div class="goodsImg">
          ...
          <div class="item">
            ...
            <div class="item_2">
              ...
              <p class="sold">
                <el-progress :percentage="item.sold" color="#e0a3a3" :stroke-width="10"></el-progress>
                <span>已抢</span>
              </p>
            </div>
          </div>
      ...
      <div class="like">
        ...
        <a
          ...
          class="like_goods"
          v-for="(item,index) in likeArr.group_list"
          :key="index"
        >
