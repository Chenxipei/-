<template>
       <div class="login">
        ...
        <div class="main_wrap">
            <!-- 用户框 -->
            <div class="main_content mauto clearfix">
                    ...
                    <div class="login_register">
                        ...
                        <div class="content_wrap">
                            ...
                            <!-- <div class="login_con">
                                ...
                                <div class="user_btn">登录</div>
                                <div class="jihuo">
                                    <p>
                                        <span class="activate_btn">新用户注册</span> |
                                        <span class="conversion">积分卡兑换</span>
                                    </p>
                                </div>
                            </div> -->
            ...
            <!-- <img src="https://www.lishe.cn/sign/images/login2.jpg" alt=""> -->
            <!-- <img src="https://www.lishe.cn/sign/images/login3.jpg" alt=""> -->
        </div>
        <!-- 尾部 -->
        <div class="footerdimension mauto">
            <div class="footer_statement">
                <ul class="clearfix">
                    <li>
                        <img class="fl" src="https://www.lishe.cn/sign/v2/images/statement_1.png" alt="">
                    ...
                    <li>
                        <img class="fl" src="https://www.lishe.cn/sign/v2/images/statement_2.png" alt="">
                        <div class="fl statement_text_pr">
                    ...
                    <li>
                        <img class="fl" src="https://www.lishe.cn/sign/v2/images/statement_3.png" alt="">
                        <div class="fl statement_text_pr">
                    ...
                    <li>
                        <img class="fl" src="https://www.lishe.cn/sign/v2/images/statement_4.png" alt="">
                        <div class="fl statement_text_pr">
...
/* 主体 */
.login .content_wrap, .back_inp {
  position: relative;
}
.login .user_inp_icon1, .user_inp_icon2, .user_inp_icon3, .user_inp_icon4 {
  float: left;
  width: 41px;
  height: 44px;
}
/* 验证码按钮 */
/* 自动登录/忘记密码 */
.login .text_con1 span ,.text_con1 label {
  cursor: pointer;
}
.login .text_con1 label:hover,.text_con1 span:hover {
  color: red;
}
/* 登录按钮 */
.login .user_btn:hover, .user_inp3 .send_btn:hover {
  background: #cc342d;
}
/* 最底下的新用户注册 */
.login .login_con, .back_inp_con {
  width: 100%;
  position: absolute;
  top: 0;
  left: 0;
...
.login .login_con .user_inp1, .user_inp2, .user_inp3, .user_inp4 {
  position: relative;
  margin-bottom: 10px;
  width: 270px;
  height: 46px;
